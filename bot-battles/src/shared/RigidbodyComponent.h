...
#endif
{
    ...
    void SetAsCircle(const glm::vec2& position, F32 rotation, F32 radius, const Entity& entity);
    void SetAsBox(const glm::vec2& position, F32 rotation, const glm::vec2& halfSize, const Entity& entity);
