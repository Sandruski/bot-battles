...
enum class ComponentMemberType : U64 {
    ...
    LABEL_EXTRA_OFFSET = 1ULL << 11,
    LABEL_TEXT = 1ULL << 12,
    LABEL_COLOR = 1ULL << 13,

    // Sprite
    SPRITE_FILE = 1ULL << 14,
    SPRITE_SPRITE_NAME_TO_TEXTURE_COORDS = 1ULL << 15,
    SPRITE_SPRITE_NAME = 1ULL << 16,
    SPRITE_COLOR = 1ULL << 17,
    SPRITE_PCT = 1ULL << 18,
    ...
    WEAPON_HIT_ENTITY_LAST_SHOT = 1ULL << 35,
    ...
    HEALTH_HIT_ENTITY_LAST_SHOT = 1LL << 41,

    // Sight
    SIGHT_ANGLE = 1ULL << 42,
    SIGHT_DISTANCE = 1ULL << 43,

    // Bot
    BOT_ACTION_TYPE = 1ULL << 44,
    ...
    HEALTH_ALL = HEALTH_CURRENT_HP | HEALTH_MAX_HP | HEALTH_HP | HEALTH_TIME_HEAL | HEALTH_COOLDOWN_HEAL | HEALTH_HIT_ENTITY_LAST_SHOT,
