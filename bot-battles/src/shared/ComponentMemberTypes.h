...
enum class ComponentMemberType : U32 {
    ...
    COLLIDER_SIZE = 1 << 9,
    COLLIDER_SHAPE_TYPE = 1 << 10,

    // Rigidbody
    RIGIDBODY_ENABLED = 1 < 11,
    RIGIDBODY_BODY_TYPE = 1 << 12,
    RIGIDBODY_GROUP_INDEX = 1 << 13,
    ...
    SPRITE_ENABLED = 1 << 22,
    SPRITE_FILE = 1 << 23,
    SPRITE_SPRITE_NAME_TO_TEXTURE_COORDS = 1 << 24,
    SPRITE_SPRITE_NAME = 1 << 25,
#endif
    ...
    RIGIDBODY_ALL = RIGIDBODY_ENABLED | RIGIDBODY_BODY_TYPE | RIGIDBODY_GROUP_INDEX,
