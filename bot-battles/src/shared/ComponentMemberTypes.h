...
enum class ComponentMemberType : U32 {
    ...
    ALL = TRANSFORM_ALL | WEAPON_ALL | COLLIDER_ALL | RIGIDBODY_ALL | HEALTH_ALL | SIGHT_ALL | SPAWN_ALL | LABEL_ALL | SPRITE_ALL
#else

    ALL = TRANSFORM_ALL | WEAPON_ALL | COLLIDER_ALL | RIGIDBODY_ALL | HEALTH_ALL | SIGHT_ALL | SPAWN_ALL
#endif
};
}
