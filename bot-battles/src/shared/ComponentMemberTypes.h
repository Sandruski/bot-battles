...
enum class ComponentMemberType : U64 {
    ...
    WEAPON_HAS_HIT = 1ULL << 28,

    // Health
    HEALTH_CURRENT_HEALTH = 1ULL << 29,
    HEALTH_MAX_HEALTH = 1ULL << 30,

    // Sight
    SIGHT_ANGLE = 1ULL << 31,
    SIGHT_DISTANCE = 1ULL << 32,

    TRANSFORM_ALL = TRANSFORM_POSITION | TRANSFORM_LAYER_TYPE | TRANSFORM_ROTATION | TRANSFORM_SCALE,
    WEAPON_ALL = WEAPON_WEAPON_PRIMARY | WEAPON_DAMAGE_PRIMARY | WEAPON_DAMAGE_SECONDARY | WEAPON_AMMO_PRIMARY | WEAPON_RANGE_PRIMARY | WEAPON_RANGE_SECONDARY | WEAPON_COOLDOWN_PRIMARY | WEAPON_COOLDOWN_SECONDARY | WEAPON_HAS_SHOT | WEAPON_HAS_HIT,
