...
enum class ComponentMemberType : U64 {
    ...
    SPRITE_FLIPPED_HORIZONTALLY = 1ULL << 19,
    SPRITE_FLIPPED_VERTICALLY = 1ULL << 20,
    SPRITE_COLOR = 1ULL << 21,
    SPRITE_PCT = 1ULL << 22,

    // GAMEPLAY
    // Weapon
    WEAPON_DAMAGE_PRIMARY = 1ULL << 23,
    WEAPON_DAMAGE_SECONDARY = 1ULL << 24,
    WEAPON_CURRENT_AMMO_PRIMARY = 1ULL << 25,
    WEAPON_MAX_AMMO_PRIMARY = 1ULL << 26,
    WEAPON_AMMO_PRIMARY = 1ULL << 27,
    WEAPON_RANGE_PRIMARY = 1ULL << 28,
    WEAPON_RANGE_SECONDARY = 1ULL << 29,
    WEAPON_TIME_SHOOT_PRIMARY = 1ULL << 30,
    WEAPON_COOLDOWN_SHOOT_PRIMARY = 1ULL << 31,
    WEAPON_TIME_SHOOT_SECONDARY = 1ULL << 32,
    WEAPON_COOLDOWN_SHOOT_SECONDARY = 1ULL << 33,
    WEAPON_TIME_RELOAD = 1ULL << 34,
    WEAPON_COOLDOWN_RELOAD = 1ULL << 35,
    WEAPON_ORIGIN_LAST_SHOT = 1ULL << 36,
    WEAPON_DESTINATION_LAST_SHOT = 1ULL << 37,
    WEAPON_HIT_ENTITY_LAST_SHOT = 1ULL << 38,

    // Health
    HEALTH_CURRENT_HP = 1ULL << 39,
    HEALTH_MAX_HP = 1ULL << 40,
    HEALTH_HP = 1ULL << 41,
    HEALTH_TIME_HEAL = 1ULL << 42,
    HEALTH_COOLDOWN_HEAL = 1ULL << 43,
    HEALTH_HIT_ENTITY_LAST_SHOT = 1ULL << 44,
    HEALTH_DIRECTION_LAST_SHOT = 1ULL << 45,

    // Sight
    SIGHT_ANGLE = 1ULL << 46,
    SIGHT_DISTANCE = 1ULL << 47,

    // Bot
    BOT_ACTION_TYPE = 1ULL << 48,
    BOT_TIME_ACTION = 1ULL << 49,
    ...
    SPRITE_ALL = SPRITE_FILE | SPRITE_SPRITE_NAME_TO_TEXTURE_COORDS | SPRITE_SPRITE_NAME | SPRITE_FLIPPED_HORIZONTALLY | SPRITE_FLIPPED_VERTICALLY,
